...
public class MailConstants {
    ...
    public static final String MAIL_QUEUE_NAME = "mtc.mail.queue";
    public static final String MAIL_EXCHANGE_NAME = "mtc.mail.exchange";
    public static final String MAIL_ROUTING_KEY_NAME = "mtc.mail.routing.key";
}
